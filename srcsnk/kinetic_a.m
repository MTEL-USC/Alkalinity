function [A,b,output] = kinetic_a(A,b,do)
% kinetic dissolution of aragonite
fprintf('%s','kinetic_a...')

% unpack the key parameters
SF = do.kinetic_a.SF;
sedremin = do.kinetic_a.sedremin;
...
EPROD = PPROD.*CtoP.*ARAGPOC_TW.*SF.*2; % 106 is the  C:P ratio; 2 is to double ALK from PIC
eprod = EPROD(ao.iocn);
